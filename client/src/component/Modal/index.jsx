...
const Modal = ({
  ...
  return (
    <div tabIndex="-1" aria-hidden="true" className={`${!open ? 'hidden':'block'} overflow-y-auto bg-gray-900  bg-opacity-60 overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
