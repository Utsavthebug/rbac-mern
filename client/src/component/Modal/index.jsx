...
const Modal = ({
  ...
  return (
    <div tabIndex="-1" aria-hidden="true" className={`${!open ? 'hidden':'block'} overflow-hidden bg-gray-900  bg-opacity-60 overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-full max-h-full`}>
